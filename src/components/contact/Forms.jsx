      ...
      >
        ...
        variants={item}
          ...
          {...register("name", {
            ...
            minLength: {
              value: 3,
              message: "Name should not be less than three characters",
            },
          })}
        ...
        variants={item}
          ...
          {...register("email", {
            ...
            minLength: {
              value: 4,
              message: "Email should be at least 4 characters long",
            },
          })}
          className="w-full p-2 rounded-md shadow-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 custom-bg"
        />
        {errors.email && (
          ...
          {...register("message", {
            ...
            maxLength: {
              value: 250,
              message: "Text should not be more than 250 characters",
            },
            minLength: {
              value: 20,
              message: "Text should be less than 20 characters",
            },
          })}
          className="w-full p-2 rounded-md shadow-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 custom-bg"
        />
